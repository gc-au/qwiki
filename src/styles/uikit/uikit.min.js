...
!(function(t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ? (module.exports = e())
        : "function" == typeof define && define.amd ? define("uikit", e) : (t.UIkit = e());
})(this, function() {
    "use strict";
    function t(t, e) {
        return function(i) {
    ...
    function Q(t, e) {
        for (var i = 0, n = [e, "data-" + e]; i < n.length; i++) if (J(t, n[i])) return X(t, n[i]);
    }
    function K(t, e) {
            ...
            Bt(function() {
                if (t.state !== Dt)
                    for (; t.deferred.length; ) {
                        ...
                        try {
                            0 === t.state
                                ? b(i) ? o(i.call(void 0, t.value)) : o(t.value)
                                : 1 === t.state && (b(n) ? o(n.call(void 0, t.value)) : r(t.value));
                        } catch (t) {
                            r(t);
                        }
                    }
    ...
    function Pt(t, e) {
        return new Nt(function(i, n) {
            var o = j({ data: null, method: "GET", headers: {}, xhr: new XMLHttpRequest(), beforeSend: R, responseType: "" }, e);
            o.beforeSend(o);
            var r = o.xhr;
            for (var s in o)
                if (s in r)
            ...
            kt(r, "load", function() {
                0 === r.status || (r.status >= 200 && r.status < 300) || 304 === r.status
                    ? i(r)
    ...
    function Kt(t) {
        ...
        return (
            Zt.test(t) ? i.insertAdjacentHTML("beforeend", t.trim()) : (i.textContent = t), i.childNodes.length > 1 ? z(i.childNodes) : i.firstChild
        );
    }
    function te(t, e) {
            ...
            (e = e.filter(Boolean)),
                z(t).forEach(function(t) {
                    for (var i = t.classList, o = 0; o < e.length; o++)
                        ue.Force ? i.toggle.apply(i, [e[o]].concat(n)) : i[(N(n) ? !i.contains(e[o]) : n) ? "add" : "remove"](e[o]);
                });
        }
    }
    function ae(t, e, i) {
            ...
            e ||
                (e = ge[t] =
                    (function(t) {
                        ...
                        var e,
                            i = we.length;
                        for (; i--; ) if ((e = "-" + we[i] + "-" + t) in be) return e;
                    })(t) || t),
            e
        );
    }
                    ...
                    return new Nt(function(o, r) {
                        ...
                        It(
                            ...
                            function(e) {
                                ...
                                clearTimeout(l),
                                    ie(t, "uk-transition"),
                                    he(t, { "transition-property": "", "transition-duration": "", "transition-timing-function": "" }),
                ...
                z(t).map(function(t) {
                    return new Nt(function(s, a) {
                        if (re(t, $e))
                            ...
                            h(e, ke) && (n && (l += " uk-transform-origin-" + n), o && (l += " " + ke + "reverse")),
                                u(),
                                It(
                                    t,
    ...
    function Ne(t, e, i, n, o, r, s, a) {
        ...
        return (
            We(h, i, u, -1),
            We(h, n, c, 1),
            (o = je(o, u.width, u.height)),
            (r = je(r, c.width, c.height)),
            (o.x += r.x),
            (o.y += r.y),
            (h.left += o.x),
            (h.top += o.y),
    ...
    function Be(t) {
        ...
        if (k(t)) {
            var o = t.innerHeight,
                r = t.innerWidth;
            return { top: i, left: n, height: o, width: r, bottom: i + o, right: n + r };
        }
        var s = !1;
    ...
    function He(t, e) {
        return "border-box" === he(e, "boxSizing")
            ? _e[t]
                  .slice(1)
                  .map(l)
                  .reduce(function(t, i) {
    ...
    function je(t, e, i) {
        var n = (t || "").split(" "),
            o = n[0],
            r = n[1];
        return { x: o ? M(o) * (f(o, "%") ? e / 100 : 1) : 0, y: r ? M(r) * (f(r, "%") ? i / 100 : 1) : 0 };
    }
    function Fe(t) {
        switch (t) {
            case "left":
    ...
    function Ve(t, e, i) {
        ...
        var n = Re((t = O(t)));
        return vt(t) && Y(t.getBoundingClientRect(), { top: e, left: i, bottom: e + Oe(n), right: i + Pe(n) });
    }
    function Re(t) {
    ...
    var Ue = "rtl" === X(document.documentElement, "dir"),
        ...
        ii = {
            ...
            flush: function() {
                oi(this.reads),
                    oi(this.writes.splice(0, this.writes.length)),
                    (this.scheduled = !1),
                    (this.reads.length || this.writes.length) && ni();
            }
        };
    function ni() {
    ...
    si.prototype = {
        ...
        movesTo: function(t) {
            ...
            var o = [[{ x: e.left, y: e.top }, { x: e.right, y: e.bottom }], [{ x: e.right, y: e.top }, { x: e.left, y: e.bottom }]];
            return (
                e.right <= i.x ||
    ...
    var li = {};
    (li.args = li.events = li.init = li.created = li.beforeConnect = li.connected = li.ready = li.beforeDisconnect = li.disconnected = li.destroy = function(
        t,
        e
    ) {
    ...
    function ci(t, e) {
        var n = {};
        if (e.mixins) for (var o = 0, r = e.mixins.length; o < r; o++) t = ci(t, e.mixins[o]);
        for (var s in t) l(s);
    ...
    (di.prototype.isVideo = function() {
        ...
        (di.prototype.enableApi = function() {
            ...
            var e,
                ...
                n = this.isVimeo();
            return i || n
                ? (this.ready = new Nt(function(o) {
                      It(t.el, "load", function() {
                          if (i) {
                              var n = function() {
                                  return fi(t.el, { event: "listening", id: t.id });
                              };
            ...
            if (this.isVideo())
                if (this.isIFrame())
                    this.enableApi().then(function() {
                        return fi(t.el, { func: "playVideo", method: "play" });
                    });
        ...
        (di.prototype.pause = function() {
            ...
            this.isVideo() &&
                (this.isIFrame()
                    ? this.enableApi().then(function() {
                          return fi(t.el, { func: "pauseVideo", method: "pause" });
                      })
        ...
        (di.prototype.mute = function() {
            ...
            this.isVideo() &&
                (this.isIFrame()
                    ? this.enableApi().then(function() {
                          return fi(t.el, { func: "mute", method: "setVolume", value: 0 });
                      })
        ...
        kt(
            ...
            kt(document, Ze, function(t) {
                var e = t.target,
                    ...
                    s = $i(t.type);
                (wi.type && wi.type !== s) ||
                    ((wi.el = "tagName" in e ? e : e.parentNode),
                    pi && clearTimeout(pi),
                    (wi.x1 = n),
                    (wi.y1 = o),
                    wi.last && r - wi.last <= 250 && (wi = {}),
                    (wi.type = s),
                    (wi.last = r),
                    (vi = t.button > 0));
            }),
            ...
            kt(document, Ke, function(t) {
                var e = t.type,
                    i = t.target;
                wi.type === $i(e) &&
                    ((wi.x2 && Math.abs(wi.x1 - wi.x2) > 30) || (wi.y2 && Math.abs(wi.y1 - wi.y2) > 30)
    ...
    (Ei.util = Ii),
            ...
            (t.use = function(t) {
                ...
                (t.mixin = function(e, i) {
                    (i = (S(i) ? t.components[i] : i) || this),
                        ((e = ci({}, e)).mixins = i.options.mixins),
                        delete i.options.mixins,
                        (i.options = ci(e, i.options));
                }),
                (t.extend = function(t) {
                    t = t || {};
                    var e = function(t) {
                ...
                (t.update = function(t, i) {
                    for (
                        i = Et(i || "update"),
                            te((t = t ? O(t) : document.body), function(t) {
                                return n(t[e], i);
                            });
                        t && t.parentNode;

                    )
                        n(t.parentNode[e], i), (t = t.parentNode);
                });
            var i;
        ...
        ((Ci = Ei).prototype._callHook = function(t) {
            var e = this,
                i = this.$options[t];
            i &&
    ...
    !(function(e) {
        ...
        (e.prototype.props = {}),
            (e.prototype._init = function(t) {
                (t = t || {}),
                    (t = this.$options = ci(this.constructor.options, t)),
                    (this.$el = null),
            ...
            (e.prototype._initData = function() {
                ...
                for (var a in j({}, e, r))
                    this.$props[a] = this[a] = i(n, a) && !N(n[a]) ? c(r[a], n[a], s) : e ? (e[a] && w(e[a]) ? e[a].concat() : e[a]) : null;
            }),
            ...
            (e.prototype._initObserver = function() {
                ...
                !this._observer &&
                    ...
                    this._observer.observe(s, { attributes: !0, attributeFilter: i.concat([this.$name, "data-" + this.$name]) }));
            });
        function r(t, e) {
            var i = {},
                n = t.args;
            ...
            (t.prototype.$mount = function(t) {
                ...
                (t.prototype.$destroy = function(t) {
                    ...
                    n && this._callDisconnected(),
                        ...
                        n && n[e] && (delete n[e][o], Object.keys(n[e]).length || delete n[e], t && Ut(this.$el));
                });
        })(Ei),
        (function(t) {
            var e = t.data;
            (t.components = {}),
                    ...
                    return (
                        ...
                        (t[n] = function(e, i) {
                            ...
                            function s(e) {
                                ...
                                return o && i && o.$reset(i), o || new t.components[n]({ el: e, data: i || {} });
                            }
                        }),
                        t._initialized &&
                ...
                (t.connect = function(i) {
                    if (i[e]) for (var n in i[e]) i[e][n]._callConnected();
            ...
            methods: {
                ...
                _toggleElement: function(t, e, i) {
                    ...
                    if (
                        ((e = C(e)
                            ? e
                            : Ee.inProgress(t) ? re(t, "uk-animation-leave") : xe.inProgress(t) ? "0px" === t.style.height : !this.isToggled(t)),
                        !Tt(t, "before" + (e ? "show" : "hide"), [this]))
                    )
                        return Nt.reject();
                ...
                _toggle: function(t, e) {
                    if (t) {
                        var i;
                        this.cls
                            ? (i = v(this.cls, " ") || Boolean(e) !== re(t, this.cls)) && se(t, this.cls, v(this.cls, " ") ? void 0 : e)
                            : (i = Boolean(e) === J(t, "hidden")) && X(t, "hidden", e ? null : ""),
                            Se("[autofocus]", t).some(function(t) {
                ...
                _toggleHeight: function(t, e) {
                    ...
                    return (
                        ...
                        (e
                            ...
                            : xe.start(t, this.hideProps, Math.round(this.duration * (r / s)), this.transition).then(function() {
                ...
                _toggleAnimation: function(t, e) {
                    ...
                    return (
                        Ee.cancel(t),
                        e
                            ? (this._toggle(t, !0), Ee.in(t, this.animation[0], this.duration, this.origin))
                            : Ee.out(t, this.animation[1] || this.animation[0], this.duration, this.origin).then(function() {
                                  return i._toggle(t, !1);
                              })
                    );
                }
        ...
        Bi = {
            ...
            events: [
                ...
                },
                {
                    ...
                    self: !0,
                    handler: function() {
                        re(document.documentElement, this.clsPage) ||
            ...
            methods: {
                ...
                show: function() {
                    if (!this.isToggled())
                        return (
                            this.container && this.$el.parentNode !== this.container && (Vt(this.container, this.$el), this._callConnected()),
                        ...
                        return requestAnimationFrame(function() {
                            i._toggle(t, e),
                                i.transitionDuration
                                    ? It(i.transitionElement, "transitionend", n, !1, function(t) {
    ...
    var Mi = {
        ...
        defaults: { pos: "bottom-" + (Ue ? "right" : "left"), flip: !0, offset: !1, clsPos: "" },
        computed: {
            pos: function(t) {
                var e = t.pos;
        ...
        methods: {
            positionAt: function(t, e, i) {
                ne(t, this.clsPos + "-(top|bottom|left|right)(-[a-z]+)?"), he(t, { top: "", left: "" });
                var n,
                    o = this.offset;
                ...
                var r = this.getAxis(),
                    s = Ne(
                        t,
                        e,
                        "x" === r ? Fe(this.dir) + " " + this.align : this.align + " " + Fe(this.dir),
                ...
                (this.dir = "x" === r ? a : l),
                    (this.align = "x" === r ? l : a),
                    se(t, this.clsPos + "-" + this.dir + "-" + this.align, !1 === this.offset);
            },
            getAxis: function() {
        ...
        t.component("accordion", {
            ...
            methods: {
                toggle: function(t, e) {
                    ...
                    (t = this.items[n]) &&
                        [t].concat((!this.multiple && !v(o, t) && o) || []).forEach(function(n) {
                            var r = n === t,
                                s = r && !re(n, i.clsOpen);
                            if (s || !r || i.collapsible || !(o.length < 2)) {
                                se(n, i.clsOpen, s);
                                var a = n._wrapper ? n._wrapper.firstElementChild : Ce(i.content, n);
                                n._wrapper || ((n._wrapper = Xt(a, "<div>")), X(n._wrapper, "hidden", s ? "" : null)),
    ...
    function Pi(t) {
        t.component("alert", {
            ...
            args: "animation",
            props: { close: String },
            defaults: { animation: [!0], selClose: ".uk-alert-close", duration: 150, hideProps: j({ opacity: 0 }, Di.defaults.hideProps) },
            events: [
                {
                    name: "click",
                    delegate: function() {
    ...
    function zi(t) {
        Ht(function() {
            var e = 0,
                i = 0;
            if (
                (kt(window, "load resize", function(e) {
    ...
    function Wi(t) {
        ...
        t.component("drop", {
            ...
            connected: function() {
                ...
                (this.toggle = e && t.toggle(S(e) ? K(e, this.$el) : this.$el.previousElementSibling, { target: this.$el, mode: this.mode })),
            ...
            events: [
                    ...
                    handler: function(t) {
                        xi(t) ||
                            (e &&
                                ...
                                !xt(t.target, e.toggle.$el) &&
                                !q({ x: t.pageX, y: t.pageY }, De(e.$el)) &&
                                e.hide(!1),
                            t.preventDefault(),
                ...
                },
                {
                    ...
                    handler: function() {
                        this.tracker.init(),
                            this.toggle && (ee(this.toggle.$el, this.cls), X(this.toggle.$el, "aria-expanded", "true")),
                            (function() {
                                if (i) return;
                                (i = !0),
                                    kt(document, "click", function(t) {
                                        ...
                                        if (!o) for (; e && e !== i && !xt(n, e.$el) && (!e.toggle || !xt(n, e.toggle.$el)); ) (i = e), e.hide(!1);
                                    });
                            })();
                    }
                },
                        ...
                        this.$el === i
                            ? ((e = this.isActive() ? null : e),
                              this.toggle &&
                                  ...
                                  this.toggle.$el.blur(),
                                  Se("a, button", this.toggle.$el).forEach(function(t) {
                                      return t.blur();
                                  })),
                              this.tracker.cancel())
                            : (e = null === e && xt(i, this.$el) && this.isToggled() ? this : e);
                    }
                }
            ],
            update: {
                ...
                hide: function(t) {
                    ...
                    this.clearTimers(),
                        ...
                        t && this.isDelaying
                            ...
                            : t && this.delayHide ? (this.hideTimer = setTimeout(i, this.delayHide)) : i();
                },
    ...
    function ji(t) {
        t.component("form-custom", {
            ...
            update: function() {
                ...
                if (t) {
                    var i;
                    t[bt(t) ? "value" : "textContent"] =
                        e.files && e.files[0]
                            ? e.files[0].name
                            : ut(e, "select") &&
                              (i = Se("option", e).filter(function(t) {
                                  return t.selected;
                              })[0])
                                ? i.textContent
                                : e.value;
                ...
                match: function(t) {
                    ...
                    return (
                        t.forEach(function(t) {
                            var n, o;
                            vt(t) ||
                                ((n = X(t, "style")), (o = X(t, "hidden")), X(t, { style: (n || "") + ";display:block !important;", hidden: null })),
                            ...
                            !0 === this.offsetBottom
                                ...
                                : _(this.offsetBottom)
                                    ...
                                    : this.offsetBottom && f(this.offsetBottom, "px")
                                        ? (n += M(this.offsetBottom))
                                        : S(this.offsetBottom) && (n += e(K(this.offsetBottom, this.$el))),
                            (t = n ? "calc(100vh - " + n + "px)" : "100vh");
                    }
                    if (t) {
                        he(this.$el, { height: "", minHeight: t });
    ...
    function un(t) {
        ...
        t.component(
            ...
            n("search-icon", {
                init: function() {
                    re(this.$el, "uk-search-icon") && dt(this.$el, ".uk-search-large").length
                        ? (this.icon = "search-large")
                        : dt(this.$el, ".uk-search-navbar").length && (this.icon = "search-navbar");
                }
            }),
            n("close", {
                init: function() {
            ...
            update: [
                {
                    ...
                    write: function(t) {
                        se(this.wrapper, this.clsHide, t.hide),
                ...
                update: {
                    write: function() {
                        if (this.panel && this.modal) {
                            ...
                            he(he(this.$el, "maxHeight", 150), "maxHeight", Math.max(150, 150 + Oe(this.modal) - this.panel.offsetHeight)),
                                t !== he(this.$el, "maxHeight") && Tt(this.$el, "resize");
                        }
                    },
                    events: ["load", "resize"]
                }
    ...
    function pn(t) {
        t.component("navbar", {
            ...
            beforeConnect: function() {
                ...
                (this.dropbar = t && ((S(t) && K(t, this.$el)) || Ce("<div></div>"))),
                    this.dropbar &&
                        (ee(this.dropbar, "uk-navbar-dropbar"), "slide" === this.dropbarMode && ee(this.dropbar, "uk-navbar-dropbar-slide"));
            },
            disconnected: function() {
            ...
            update: function() {
                t.drop(
                    Se(this.dropdown + " ." + this.clsDrop, this.$el).filter(function(e) {
                ...
                },
                {
                    ...
                    handler: function(t, e) {
                        ...
                        this.clsDrop && ee(i, this.clsDrop + "-dropbar"),
                            "bottom" === n && this.transitionTo(i.offsetHeight + M(he(i, "marginTop")) + M(he(i, "marginBottom")), i);
                    }
                },
                {
                    name: "beforehide",
            ...
            methods: {
                ...
                transitionTo: function(t, e) {
                    var i = this.dropbar,
                        n = vt(i) ? Oe(i) : 0;
                    return (
                        he((e = n < t && e), { height: n, overflow: "hidden" }),
                        Oe(i, n),
                        xe.cancel([e, i]),
                        xe
    ...
    function gn(t) {
        t.component("offcanvas", {
            ...
            update: {
                write: function() {
                    this.getActive() === this &&
                        ((this.overlay || this.clsContentAnimation) && Pe(this.content, Pe(window) - this.scrollbarWidth),
                        this.overlay && (Oe(this.content, Oe(window)), mn && (this.content.scrollTop = mn.y)));
                },
                events: ["resize"]
            },
            events: [
                ...
                },
                {
                    ...
                    self: !0,
                    handler: function() {
                        (mn = mn || { x: window.pageXOffset, y: window.pageYOffset }),
                            "reveal" !== this.mode ||
                                re(this.panel, this.clsMode) ||
                                (Xt(this.panel, "<div>"), ee(this.panel.parentNode, this.clsMode)),
                            he(
                                document.documentElement,
                                "overflowY",
                                (!this.clsContentAnimation || this.flip) && this.scrollbarWidth && this.overlay ? "scroll" : ""
                            ),
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        } else mn = { x: window.pageXOffset, y: window.pageYOffset };
                        ie(this.panel, this.clsSidebarAnimation, this.clsMode),
                            ...
                            (document.body.scrollTop = mn.y),
                            he(document.documentElement, "overflowY", ""),
                            Pe(this.content, ""),
                            Oe(this.content, ""),
                            window.scrollTo(mn.x, mn.y),
                            (mn = null);
                    }
                },
                {
                    ...
                    handler: function(t) {
                        this.isToggled() &&
                            xi(t) &&
                            (("swipeLeft" === t.type && !this.flip) || ("swipeRight" === t.type && this.flip)) &&
                            this.hide();
                    }
                }
            ]
    ...
    function vn(t) {
        t.component("responsive", {
            ...
            update: {
                ...
                write: function(t) {
                    Oe(this.$el, U.contain({ height: this.height, width: this.width }, t).height);
                },
                events: ["load", "resize"]
            }
        });
                ...
                scrollTo: function(t) {
                    ...
                    if ((o + n > i && (o = i - n), Tt(this.$el, "beforescroll", [this, t]))) {
                        var r = Date.now(),
                            ...
                            a = function() {
                                var i,
                                    n = s + (o - s) * ((i = V((Date.now() - r) / e.duration)), 0.5 * (1 - Math.cos(Math.PI * i)));
                        ...
                        this.elements.forEach(function(o, r) {
                            ...
                            if (!s.show || s.inview || s.timer)
                                !s.show &&
                                    ...
                                    he(o, "visibility", i.hidden ? "hidden" : ""),
                                    ie(o, i.inViewClass),
                                    se(o, a),
                                    Tt(o, "outview"),
                                    t.update(o),
                ...
                },
                {
                    ...
                    write: function(t) {
                        ...
                        this.links.forEach(function(t) {
                            ...
                            e && Tt(this.$el, "active", [e, ee(this.closest ? ht(e, this.closest) : e, this.cls)]);
                    },
                    events: ["scroll", "load", "resize"]
                }
            ]
    ...
    function xn(t) {
        t.component("sticky", {
            ...
            connected: function() {
                (this.placeholder = Ce('<div class="uk-sticky-placeholder"></div>')),
                    (this.widthElement = this.$props.widthElement || this.placeholder),
                    this.isActive || this.hide();
            },
            disconnected: function() {
                this.isActive && ((this.isActive = !1), this.hide(), ie(this.selTarget, this.clsInactive)),
                    Ut(this.placeholder),
                    ...
                    write: function() {
                        ...
                        he(
                            ...
                            j(
                                ...
                                he(this.$el, ["marginTop", "marginBottom", "marginLeft", "marginRight"])
                            )
                        ),
                            xt(t, document) || (Yt(this.$el, t), X(t, "hidden", "")),
                        ...
                        var n = e("bottom", this);
                        (this.top = Math.max(M(e("top", this)), this.topOffset) - this.offset),
                            (this.bottom = n && n - i),
                    ...
                    write: function(t, e) {
                        ...
                        if (!(o < 0 || !n || this.disabled || (this.showOnUp && !r)))
                            if (
                                this.inactive ||
                                o < this.top ||
                                (this.showOnUp && (o <= this.top || "down" === r || ("up" === r && !this.isActive && o <= this.bottomOffset)))
                            ) {
                                if (!this.isActive) return;
                                (this.isActive = !1),
                                    this.animation && o > this.topOffset
                                        ? (Ee.cancel(this.$el),
                                          Ee.out(this.$el, this.animation).then(function() {
                                              return i.hide();
                                          }, R))
                                        : this.hide();
                            } else
                                this.isActive
                                    ? this.update()
                                    : this.animation ? (Ee.cancel(this.$el), this.show(), Ee.in(this.$el, this.animation).catch(R)) : this.show();
                    },
                    events: ["scroll"]
                }
            ],
            methods: {
                ...
                hide: function() {
                    (this.isActive && !re(this.selTarget, this.clsActive)) || Tt(this.$el, "inactive"),
                ...
                update: function() {
                    ...
                    this.bottom && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll),
                        ...
                        re(this.selTarget, this.clsActive) ? t || Tt(this.$el, "inactive") : t && Tt(this.$el, "active"),
                        se(this.$el, this.clsBelow, this.scroll > this.bottomOffset),
    ...
    function $n(t) {
        t.component("svg", {
                    ...
                    if (
                        (S(n)
                            ? (t.icon &&
                              ...
                              (o = Ce(n.substr(n.indexOf("<svg")))))
                            : (o = n.cloneNode(!0)),
                        !o)
                    )
                        return Nt.reject("SVG not found.");
                    var r = X(o, "viewBox");
                    r && ((r = r.split(" ")), (t.width = t.$props.width || r[2]), (t.height = t.$props.height || r[3])),
                        (t.width *= t.ratio),
                        (t.height *= t.ratio);
            ...
            disconnected: function() {
                var t = this;
                gt(this.$el) && X(this.$el, { hidden: null, id: this.id || null }),
                    this.svg &&
                        this.svg.then(function(e) {
            ...
            methods: {
                getSvg: function() {
                    ...
                    return this.src
                        ? kn[this.src]
                            ? kn[this.src]
                            : ((kn[this.src] = new Nt(function(e, i) {
                                  h(t.src, "data:")
                ...
                show: function(t) {
                    for (
                        var e,
                            ...
                            o = !!this.connects.length && Wt(yt(this.connects[0].children, "." + this.cls)[0]),
                            r = o >= 0,
                            s = "previous" === t ? -1 : 1,
                            a = Lt(t, this.toggles, o),
                            l = 0;
                        l < n;
                        l++, a = (a + s + n) % n
                    )
                    ...
                    handler: function(t) {
                        if (xi(t) || v(this.mode, "click")) {
                            ...
                            (ht(t.target, 'a[href="#"], button') ||
                                ((e = ht(t.target, "a[href]")) && (this.cls || !vt(this.target) || (e.hash && ut(this.target, e.hash))))) &&
    ...
    (Ei.version = "3.0.0-beta.42"),
        ((Sn = Ei).mixin.class = _i),
        (Sn.mixin.container = Ni),
        (Sn.mixin.modal = Bi),
        (Sn.mixin.position = Mi),
        (Sn.mixin.togglable = Di);
    var Sn;
    (An = Ei).use(En),
        An.use(Oi),
        An.use(Pi),
            ...
            t.mixin.slider = {
                            ...
                            events: [
                                {
                                    ...
                                    handler: function(t) {
                                        if (
                                            !(
                                                (!r(t) && ((e = t.target), !e.children.length && e.childNodes.length)) ||
                                                t.button > 0 ||
                                                this.length < 2 ||
                                                this.preventCatch
                                            )
                            ...
                            methods: {
                                start: function() {
                                    (this.drag = this.pos),
                                        ...
                                        (this.unbindMove = a(document, u, this.move, { capture: !0, passive: !1 })),
                                        a(window, "scroll", this.unbindMove),
                                        a(document, c, this.end, !0);
                                },
                                move: function(t) {
                                    var e = this,
                                    ...
                                    if (!(0 === i || this.prevPos === this.pos || (!this.dragging && Math.abs(i) < this.threshold))) {
                                        ...
                                        for (
                                            var o = this.slides,
                                                r = this.prevIndex,
                                                s = Math.abs(i),
                                                a = this.getIndex(r + this.dir, r),
                                                l = this._getDistance(r, a) || o[r].offsetWidth;
                                            a !== r && s > l;
                                            ...
                                            (e.drag -= l * e.dir),
                                                (r = a),
                                                (s -= l),
                                                (a = e.getIndex(r + e.dir, r)),
                                                (l = e._getDistance(r, a) || o[r].offsetWidth);
                                        this.percent = s / l;
                                        var u,
                                            c = o[r],
                                            h = o[a],
                                        ...
                                        [this.index, this.prevIndex]
                                            ...
                                            ((this.index === r && this.prevIndex !== r) || u) && d(o[this.index], "itemshown", [this]),
                                            f &&
                                                ((this.prevIndex = r),
                                                (this.index = a),
                                                !p && d(c, "beforeitemhide", [this]),
                                                d(h, "beforeitemshow", [this])),
                                            (this._transitioner = this._translate(Math.abs(this.percent), c, !p && h)),
                                            f && (!p && d(c, "itemhide", [this]), d(h, "itemshow", [this]));
                                    }
                                },
                                end: function() {
                            ...
                            update: [
                                {
                                    write: function() {
                                        ...
                                        this.nav &&
                                            ...
                                            s(n(this.navItemSelector, this.$el).concat(this.nav), "uk-hidden", !this.maxIndex),
                                            this.updateNav();
                                    },
                                    events: ["load", "resize"]
                                }
                            ...
                            methods: {
                                updateNav: function() {
                                    ...
                                    this.navItems.forEach(function(i) {
                                        ...
                                        s(i, t.clsActive, a(n) === e),
                                            s(i, "uk-invisible", t.finite && (("previous" === n && 0 === e) || ("next" === n && e >= t.maxIndex)));
                                    });
                                }
                            }
                        };
                ...
                methods: {
                            ...
                            if ((n[e ? "unshift" : "push"](t), !e && n.length > 1))
                                ...
                                if (u !== f) {
                                    ...
                                    if (
                                        ((this.prevIndex = l),
                                        (this.index = h),
                                        u && d(u, "beforeitemhide", [this]),
                                        !d(f, "beforeitemshow", [this, u]))
                                    )
                    ...
                    getIndex: function(t, e) {
                        return (
                            void 0 === t && (t = this.index), void 0 === e && (e = this.index), o(s(t, this.slides, e, this.finite), 0, this.maxIndex)
                        );
                    },
                        ...
                        if (
                            ((this._transitioner = this._getTransitioner(
                                ...
                                n(
                                    {
                                        easing: i
                                            ? e.offsetWidth < 600 ? "cubic-bezier(0.25, 0.46, 0.45, 0.94)" : "cubic-bezier(0.165, 0.84, 0.44, 1)"
                                            : this.easing
                                    },
                            ...
                            return this._transitioner.translate(1), c.resolve();
                    ...
                    _getTransitioner: function(t, e, i, n) {
                        return (
                            ...
                            new this.Transitioner(l(t) ? this.slides[t] : t, l(e) ? this.slides[e] : e, i * (u ? -1 : 1), n)
                        );
                    }
                }
            };
    ...
    function Mn(t) {
        if (!Mn.installed) {
                ...
                l = (function(t) {
                    var e = t.util.css,
                        i = {
                            slide: {
                                show: function(t) {
                                    return [{ transform: _n(-100 * t) }, { transform: _n() }];
                                },
                                percent: function(t) {
                                    return i.translated(t);
                                },
                                translate: function(t, e) {
                                    return [{ transform: _n(-100 * e * t) }, { transform: _n(100 * e * (1 - t)) }];
                                }
                            },
                        ...
                        return {
                            ...
                            show: function(o, r, u) {
                                ...
                                return (
                                    ...
                                    this.translate(r),
                                    c(e, "itemin", { percent: r, duration: o, timing: f, dir: i }),
                                    c(t, "itemout", { percent: 1 - r, duration: o, timing: f, dir: i }),
                            ...
                            translate: function(n) {
                                ...
                                o(e, r[1]),
                                    o(t, r[0]),
                                    c(e, "itemtranslatein", { percent: n, dir: i }),
                                    c(t, "itemtranslateout", { percent: 1 - n, dir: i });
                            },
                            percent: function() {
                                return f(t || e, e, i);
                            },
            ...
            t.mixin.slideshow = {
                ...
                defaults: { animation: "slide", clsActivated: "uk-transition-active", Animations: l, Transitioner: u },
                computed: {
                    animation: function(t) {
                        var e = t.animation,
                            i = t.Animations;
                        return o(e in i ? i[e] : i.slide, { name: e });
                    },
    ...
    function On(t) {
        if (!On.installed) {
            ...
            var e = t.mixin,
                ...
                b = (function(t) {
                    ...
                    return n({}, e.slideshow.defaults.Animations, {
                        ...
                        scale: {
                            show: function() {
                                return [{ opacity: 0, transform: Nn(0.8) }, { opacity: 1, transform: Nn(1) }];
                            },
                            percent: function(t) {
                                return 1 - o(t, "opacity");
                            },
                            translate: function(t) {
                                return [{ opacity: 1 - t, transform: Nn(1 - 0.2 * t) }, { opacity: t, transform: Nn(0.8 + 0.2 * t) }];
                            }
                        }
                    });
                })(t);
            t.component("lightbox-panel", {
                ...
                created: function() {
                    var t = this;
                    this.$mount(s(this.container, this.template)),
                        (this.caption = n(".uk-lightbox-caption", this.$el)),
                        this.items.forEach(function() {
                            return s(t.list, "<li></li>");
                        });
                },
                events: [
                    { name: m + " " + p + " keydown", handler: "showControls" },
                    {
                        name: "click",
                        self: !0,
                        delegate: function() {
                    ...
                    },
                    {
                        ...
                        handler: function(t) {
                            this.isToggled() ||
                                ...
                                t.preventDefault(),
                                this.toggleNow(this.$el, !0),
                                (this.animation = b.scale),
                                g(t.target, this.clsActive),
                                ...
                                if ("image" === s || o.match(/\.(jp(e)?g|png|gif|svg)$/i))
                                    c(o).then(
                                        function(t) {
                                            return i.setItem(
                                                e,
                                                '<img width="' + t.width + '" height="' + t.height + '" src="' + o + '" alt="' + (a || "") + '">'
                                            );
                                        },
                                        function() {
                                            return i.setError(e);
                                    ...
                                    l(h, "src", o),
                                        ...
                                        f(h, "loadedmetadata", function() {
                                            l(h, { width: h.videoWidth, height: h.videoHeight }), i.setItem(e, h);
                                        });
                                } else if ("iframe" === s)
                                    ...
                                    var d = u[2],
                                        p = function(t, n) {
                                            return (
                                                void 0 === t && (t = 640),
                                                void 0 === n && (n = 450),
                                                i.setItem(e, y("//www.youtube" + (u[1] || "") + ".com/embed/" + d, t, n, i.videoAutoplay))
                                            );
                                        };
                                    c("//img.youtube.com/vi/" + d + "/maxresdefault.jpg").then(function(t) {
                                        var e = t.width,
                                            i = t.height;
                                        120 === e && 90 === i
                                            ? c("//img.youtube.com/vi/" + d + "/0.jpg").then(function(t) {
                                                  var e = t.width,
                                                      i = t.height;
                                                  return p(e, i);
                                              }, p)
                                    ...
                                    (u = o.match(/(\/\/.*?)vimeo\.[a-z]+\/([0-9]+).*?/)) &&
                                        r("//vimeo.com/api/oembed.json?maxwidth=1920&url=" + encodeURI(o), { responseType: "json" }).then(function(
                                            t
                                        ) {
                                            var n = t.response,
                                                o = n.height,
                        ...
                        return h.reduce(function(o, r) {
                            ...
                            if (r.match(/^bg/))
                                if (
                                    ...
                                    (l = n(e, "backgroundPosition").split(" ")["x" === r[2] ? 0 : 1]),
                                    i.covers)
                                ) {
                            ...
                            return (o[r] = { steps: p, unit: m, pos: s, bgPos: l, diff: h }), o;
                        }, {});
                    },
                    bgProps: function() {
                        var t = this;
                ...
                update: [
                    {
                        read: function(t) {
                            var e = this;
                            if (
                                ((t.active = !this.media || window.matchMedia(this.media).matches),
                                    ...
                                    this.bgProps.forEach(function(t) {
                                        ...
                                        if (l.match(/%$|0px/)) {
                                            if (h < r) s[c] = a[c] + r - h;
                                                ...
                                                var d = parseFloat(l);
                                                d &&
                                                    (e.props[t].steps = u.map(function(t) {
                                                        return t - (h - r) / (100 / d);
                                                    }));
                                            }
                                            a = o.cover(i, s);
                ...
                },
                {
                    ...
                    handler: function(t) {
                        var e = t.type,
                            ...
                            h = i.dir;
                        l.cancel(this.$el),
                            r(this.$el, this.getCss(c(e, h, n))),
                            l.start(this.$el, this.getCss(u(e) ? 0.5 : h > 0 ? 1 : 0), o, s).catch(a);
                    }
                },
                {
    ...
    return (
                ...
                e.component("countdown", {
                    ...
                    update: {
                        write: function() {
                            ...
                            e.total <= 0 && (this.stop(), (e.days = e.hours = e.minutes = e.seconds = 0)),
            ...
            if (!t.installed) {
                ...
                e.component("notification", {
                    ...
                    ready: function() {
                        ...
                        d
                            .start(a(this.$el, { opacity: 0, marginTop: -this.$el.offsetHeight, marginBottom: 0 }), {
                                opacity: 1,
                                marginTop: 0,
                                marginBottom: e
                            })
        ...
        Ei.use(function t(e) {
            if (!t.installed) {
                                    ...
                                    return {
                                        ...
                                        show: function(e, o, r) {
                                            ...
                                            return (
                                                ...
                                                (o = t ? o : n(o, 0, 1)),
                                                g(this.getItemIn(), "itemin", { percent: o, duration: e, timing: s, dir: i }),
                                                t && g(this.getItemIn(!0), "itemout", { percent: 1 - o, duration: e, timing: s, dir: i }),
                                                f.start(w, { transform: _n(-x * (u ? -1 : 1), "px") }, e, s).then(b.resolve, c),
                                                b.promise
                                            );
                                        },
                                        stop: function() {
                                        ...
                                        translate: function(e) {
                                            ...
                                            r(w, "transform", _n(n(o - o * e - x, -m.getWidth(w), w.offsetWidth) * (u ? -1 : 1), "px")),
                ...
                e.component("slider-parallax", Hn(e, "slider")),
                    e.component("slider", {
                        ...
                        computed: {
                            ...
                            sets: function(t) {
                                ...
                                return (
                                    (i =
                                        i &&
                                        this.slides.reduce(function(t, i, s) {
                                            var a = d(i);
                                            if (a.right > o && (!e.center && s > e.maxIndex && (s = e.maxIndex), !u(t, s))) {
                                                var l = e.slides[s + 1];
                                                e.center && l && a.width < r - d(l).width / 2
                                                    ? (r -= a.width)
                                                    : ((r = n), t.push(s), (o = a.left + n + (e.center ? a.width / 2 : 0)));
                                            }
                                            return t;
                                        }, [])),
                                    i && i.length && i
                        ...
                        events: {
                            beforeitemshow: function(t) {
                                ...
                                if (!this.dragging && e > 1) {
                                    ...
                                    (this.duration =
                                        Bn(this.avgWidth / this.velocity) *
                                        ((this.dir < 0 || !this.slides[this.prevIndex] ? this.slides[this.index] : this.slides[this.prevIndex])
                                            .offsetWidth /
                                            this.avgWidth)),
                                        this.reorder();
                            },
        ...
        Ei.use(function t(e) {
            if (!t.installed) {
                    ...
                    o = (function(t) {
                        var e = t.mixin,
                            ...
                            r = n({}, e.slideshow.defaults.Animations, {
                                ...
                                scale: {
                                    show: function() {
                                        return [{ opacity: 0, transform: Nn(1.5), zIndex: 0 }, { zIndex: -1 }];
                                    },
                                    percent: function(t) {
                                        return 1 - o(t, "opacity");
                                    },
                                    translate: function(t) {
                                        return [{ opacity: 1 - t, transform: Nn(1 + 0.5 * t), zIndex: 0 }, { zIndex: -1 }];
                                    }
                                },
                                pull: {
                                    show: function(t) {
                                        return t < 0
                                            ? [{ transform: _n(30), zIndex: -1 }, { transform: _n(), zIndex: 0 }]
                                            : [{ transform: _n(-100), zIndex: 0 }, { transform: _n(), zIndex: -1 }];
                                    },
                                    ...
                                    translate: function(t, e) {
                                        return e < 0
                                            ? [{ transform: _n(30 * t), zIndex: -1 }, { transform: _n(-100 * (1 - t)), zIndex: 0 }]
                                            : [{ transform: _n(100 * -t), zIndex: 0 }, { transform: _n(30 * (1 - t)), zIndex: -1 }];
                                    }
                                },
                                push: {
                                    show: function(t) {
                ...
                e.component("slideshow-parallax", Hn(e, "slideshow")),
                    ...
                    update: {
                        write: function() {
                            if ((this.clsEmpty && N(this.$el, this.clsEmpty, !this.$el.children.length), this.drag)) {
                                ...
                                e > 0 && e < this.scrollY
                                    ? (t = this.scrollY - 5)
                                    : i < f(document) && i > f(window) + this.scrollY && (t = this.scrollY + 5),
                                    t &&
                                        setTimeout(function() {
                    ...
                    methods: {
                        init: function(t) {
                            ...
                            !o ||
                                ...
                                (this.touched = [this]),
                                (this.placeholder = o),
                                (this.origin = a({ target: e, index: v(o) }, this.pos)),
                                k(document, I, this.move),
                                k(document, T, this.end),
                        ...
                        start: function(t) {
                            ...
                            a(this.origin, { left: n - this.pos.x, top: o - this.pos.y }),
                                ...
                                r(document.documentElement, this.clsDragState),
                        ...
                        move: function(t) {
                            if (this.drag) {
                                ...
                                var e =
                                        "mousemove" === t.type
                                            ? t.target
                                            : document.elementFromPoint(this.pos.x - document.body.scrollLeft, this.pos.y - document.body.scrollTop),
                                    i = P(e),
                        ...
                        scroll: function() {
                            ...
                            if ((x(document, I, this.move), x(document, T, this.end), x(window, "scroll", this.scroll), this.drag)) {
                                ...
                                this === e
                                    ? this.origin.index !== v(this.placeholder) && M(this.$el, "moved", [this, this.placeholder])
                                    : (M(e.$el, "added", [e, this.placeholder]), M(this.$el, "removed", [this, this.placeholder])),
                                    M(this.$el, "stop", [this]),
                                    A(this.drag),
                                    (this.drag = null);
                                var i = this.touched
                        ...
                        insert: function(t, e) {
                            ...
                            var n = function() {
                                e
                                    ? !O(t, i.$el) || ((n = t), (o = e), n.parentNode === o.parentNode && v(n) > v(o)) ? c(e, t) : s(e, t)
                                    : l(i.$el, t);
                                var n, o;
                            };
                        ...
                        animate: function(t) {
                            var i = this,
                                ...
                                r = { position: "", width: "", height: "", pointerEvents: "", top: "", left: "", bottom: "", right: "" };
                            o.forEach(function(t) {
                                n.push(a({ position: "absolute", pointerEvents: "none", width: t.offsetWidth, height: t.offsetHeight }, E(t)));
                            }),
                                t(),
                                o.forEach(B.cancel),
                                d(this.$el.children, r),
                                e.update(this.$el),
                                p.flush(),
        ...
        Ei.use(function t(e) {
            ...
            if (!t.installed) {
                ...
                e.component("tooltip", {
                    ...
                    beforeConnect: function() {
                        (this._hasTitle = l(this.$el, "title")), s(this.$el, { title: "", "aria-expanded": !1 });
                    },
                    disconnected: function() {
                        this.hide(), s(this.$el, { title: this._hasTitle ? this.title : null, "aria-expanded": null });
                    },
                    methods: {
                        show: function() {
                            var t = this;
                            u(b, this) ||
                                ...
                                b.push(this),
                                (this._unbind = f(document, "click", function(e) {
